...
<template>
    <header ref="target" :class="openNavbar ? 'shadow-none': ''"
        ...
        <button @click="openNavbar = !openNavbar" class="focus:outline-none sm:hidden">
        ...
        <Navbar @close-navbar="closeNavbar()" :openNavbar="openNavbar" />
    </header>
</template>